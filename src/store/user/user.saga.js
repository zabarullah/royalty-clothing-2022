...
export function* signUp({payload: { email, password, displayName }}) {
    try {
        const { user, displayName } = yield call(createAuthUserWithEmailAndPassword, email, password);
...
//entry point sagas, taking the action type and the associated function:
